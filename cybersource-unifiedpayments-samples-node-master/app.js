...
/**
 * 
 * Setting Paramiters for  CYBS REST SDK
 * 
 */

var cybersourceRestApi = require('cybersource-rest-client');
const { requestCaptureContext } = require('./RequestCaptureContext');
...
/**
 * 
 * Setting Cybersource API cradentials cor capture context retrival
 * 
 */


const mid = 'testrest';
const keyId = '08c94330-f618-42a3-b09d-e1e43be5efda';
const sharedSecret = 'yBJxy6LjM2TmcPGu+GaJrHtkke25fPpUX+UY6/L/1tE=';
...
// Requesting Capture Context
  ...
  CC.requestCaptureContext(JSON.stringify(options),function (error, data, response, statusCode) {
    ...
    res.render('checkout',{title: data,CaptureContext: data});
  }, false);
...
/**
 * 
 *   This Page is to display the capture Transient tokenn response from Unified Payments
 */
